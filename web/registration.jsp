...
<div class="container">
    <form action="/registration" method="post" class="col-xs-6">
        <input name="fullName" placeholder="Full Name" minlength="4" maxlength="30" class="form-control"><br>
        <input name="login" placeholder="Login" minlength="4" maxlength="30" class="form-control"><br>
        <input type="email" name="email" placeholder="Email" minlength="4" maxlength="30" class="form-control"><br>
        <input type="password" name="password" placeholder="Password" minlength="4" maxlength="30" class="form-control"><br>
