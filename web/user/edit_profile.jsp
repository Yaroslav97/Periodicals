...
<div class="container">
    <form action="/editProfile" method="post" class="col-xs-6">
        <input name="fullName" minlength="4" placeholder="Full Name"
               value="${sessionScope.authenticatedFullName}" class="form-control"><br>
        <input type="email" name="email" minlength="4" placeholder="Email"
               value="${sessionScope.authenticatedEmail}" class="form-control"><br>
        <input type="password" name="password" minlength="4" placeholder="New password" class="form-control"><br>
