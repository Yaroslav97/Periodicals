...
<form action="/editEdition" method="post" class="col-xs-6">
    <input name="name" value="${sessionScope.editName}" minlength="3" placeholder="Name" class="form-control"><br>
    <input name="subject" value="${sessionScope.editSubject}" minlength="3" placeholder="Subject" class="form-control"><br>
    <input type="number" name="price" value="${sessionScope.editPrice}" minlength="1" placeholder="Price" class="form-control"><br>
